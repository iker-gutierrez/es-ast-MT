...
#SBATCH --mem=64GB
#SBATCH --gres=gpu:1
#SBATCH --output=/home/igutierrez134/MT/asturian-shared-task/logs/inference_baseline_%j.log
#SBATCH --error=/home/igutierrez134/MT/asturian-shared-task/logs/inference_baseline_%j.err
