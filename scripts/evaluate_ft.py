...
PRED_PATH = Path("./workspace/predictions_ft/predictions.json")
REF_PATH = Path("./workspace/predictions_ft/references.json")
OUTPUT_PATH = Path("./workspace/predictions_ft/metrics_results.json")
...
bleu = sacrebleu.corpus_bleu(preds, refs_for_bleu)
